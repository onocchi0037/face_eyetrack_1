...
def main(Persons,
    ...
    predictor_path68 = "./dlib/shape_predictor_68_face_landmarks.dat"
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            for face_id in face_data_dict:
                ...
                if eye_w and eye_h:
                    if type(display_image) != 'cv2.UMat':
                        ...
                        display_image = cv2.circle(display_image, (int(disp_resolution_w*eye_w_org), int(disp_resolution_h*eye_h_org)), disp_resolution_h//10, (0,0,255), -1)
